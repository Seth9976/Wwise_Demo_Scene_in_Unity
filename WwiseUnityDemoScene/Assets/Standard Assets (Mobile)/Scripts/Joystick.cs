...
public class Joystick : MonoBehaviour
{
	...
	private void Update()
	{
		...
		//	phase = Input.GetMouseButtonDown(0) ? TouchPhase.Began : Input.GetMouseButton(0) ? TouchPhase.Moved : Input.GetMouseButtonUp(0) ? TouchPhase.Ended : TouchPhase.Canceled
		//};
